...
import 'ReserveDailySeatController.dart';
class DatePickerController2 extends GetxController {
...
class ReserveDailySeat extends StatelessWidget {
  ReserveDailySeatController controller = Get.put(ReserveDailySeatController());
  final DatePickerController2 _datePickerController2 = Get.put(DatePickerController2());
  Future<void> _selectDate(BuildContext context) async {
    ...
    if (newDate != null) {
      _datePickerController2.updateDate(newDate);
    }}
  @override
            ...
            body: SingleChildScrollView(
              child: Column(
                  children: [
                    ...
                    Text('Price Per Day : 5000 PS',style:  TextStyle(fontSize: 20, color: Colors.black87,fontFamily: ' Quicksand',),),
                    SizedBox(
                          ...
                          child:  Container(
                              ...
                              child: Padding(
                                ...
                                Obx(() {
                                  ...
                                  DateFormat('yyyy-MM-dd').format(_datePickerController2.selectedDate.value);
                                  return Text(
                    ...
                    InkWell(
                      ...
                      async {
                        ...
                        final date= _datePickerController2.selectedDate.value;
                        ...
                        await controller.confirmSeatDailyReservation( firstName,lastName,date,satrtHoure,endtHoure );
                        Get.to(Home());
                      },
